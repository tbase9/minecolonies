...
public class HunterConstants
{
    ...
    /**
     * Range a hunter should be within of HunterPos.
     */
    public static final int HUNTER_POS_RANGE = 3;
     ...
     */
    public static final int HUNTER_BASE_DMG = 2;
