...
public class HunterScepterMessage extends AbstractColonyServerMessage
{
    /**
     * The id of the task.
     */
     ...
     */
    public HunterScepterMessage(final IBuildingView building, final int taskId)
    {
