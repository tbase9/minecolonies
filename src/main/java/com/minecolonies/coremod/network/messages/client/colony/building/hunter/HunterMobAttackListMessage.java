package com.minecolonies.coremod.network.messages.client.colony.building.hunter;
...
public class HunterMobAttackListMessage implements IMessage
{
    /**
     ...
     */
    public HunterMobAttackListMessage()
    {
        super();
    }

    public HunterMobAttackListMessage(final int colonyId, final BlockPos buildingId, final List<MobEntryView> mobsToAttack)
    {
        super();
    ...
    public void onExecute(final NetworkEvent.Context ctxIn, final boolean isLogicalServer)
    {
        ...
        if (IColonyView != null)
        {
            @Nullable final BuildingHunter.View buildingView = (BuildingHunter.View) IColonyView.getBuilding(buildingId);
